...
public class GalleryInsecureFragmentAdapter extends RecyclerView.Adapter<GalleryInsecureFragmentAdapter.MyViewHolder> {
    ...
    public GalleryInsecureFragmentAdapter(Context context, ArrayList<GalleryFragmentItem> imagePathList) {
